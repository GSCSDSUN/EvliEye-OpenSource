...
public class ServerFinderScreen extends Screen
{
	...
	private void findServers()
	{
		try
		{
			...
			ArrayList<EvlieyeServerPinger> pingers = new ArrayList<>();
			...
			for(int change : changes)
				for(int i2 = 0; i2 <= 255; i2++)
				{
					...
					EvlieyeServerPinger pinger = new EvlieyeServerPinger();
					pinger.ping(ip);
					pingers.add(pinger);
	...
	private void updatePingers(ArrayList<EvlieyeServerPinger> pingers)
	{
