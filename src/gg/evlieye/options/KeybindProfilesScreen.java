...
public final class KeybindProfilesScreen extends Screen
{
	...
	public void init()
	{
		listGui = new ListGui(client, this,
			EvlieyeClient.INSTANCE.getKeybinds().listProfiles());
	...
	private void openFolder()
	{
		Util.getOperatingSystem().open(
			EvlieyeClient.INSTANCE.getKeybinds().getProfilesFolder().toFile());
	}
	...
	private void newProfile(String name)
	{
		...
		try
		{
			EvlieyeClient.INSTANCE.getKeybinds().saveProfile(name);
	...
	private void loadSelected()
	{
		...
		try
		{
			EvlieyeClient.INSTANCE.getKeybinds().loadProfile(fileName);
			openPrevScreen();
