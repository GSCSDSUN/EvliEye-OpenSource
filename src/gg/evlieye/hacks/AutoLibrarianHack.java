...
import gg.evlieye.hacks.autolibrarian.BookOffer;
import gg.evlieye.hacks.autolibrarian.FacingSetting;
import gg.evlieye.hacks.autolibrarian.SwingHandSetting;
import gg.evlieye.hacks.autolibrarian.UpdateBooksSetting;
...
import gg.evlieye.util.BlockBreaker.BlockBreakingParams;
import gg.evlieye.util.BlockPlacer;
import gg.evlieye.util.BlockPlacer.BlockPlacingParams;
import gg.evlieye.util.BlockUtils;
import gg.evlieye.util.ChatUtils;
import gg.evlieye.util.InventoryUtils;
	...
	implements UpdateListener, RenderListener
{
	...
	private void breakJobSite()
	{
		...
		// equip tool
		evlieye.getHax().autoToolHack.equipBestTool(jobSite, false, true,
