...
public abstract class NavigatorScreen extends Screen
{
	...
	{
		EvlieyeClient.INSTANCE.getGui().updateColors();
		float[] bgColor = EvlieyeClient.INSTANCE.getGui().getBgColor();
		float opacity = EvlieyeClient.INSTANCE.getGui().getOpacity();
