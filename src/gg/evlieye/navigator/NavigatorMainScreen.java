...
public final class NavigatorMainScreen extends NavigatorScreen
{
	...
	public NavigatorMainScreen()
	{
		...
		Navigator navigator = EvlieyeClient.INSTANCE.getNavigator();
	...
	protected void onMouseClick(double x, double y, int button)
	{
		...
		{
			EvlieyeClient.MC.setScreen((Screen)null);
			return;
		}
		...
		float partialTicks)
	{
		...
		if(!clickTimerRunning)
		{
			...
			EvlieyeClient.MC.textRenderer.drawWithShadow(matrixStack, "Search: ",
