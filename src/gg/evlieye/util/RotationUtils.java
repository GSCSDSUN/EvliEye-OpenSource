...
import gg.evlieye.RotationFaker;
...
public enum RotationUtils
{
	...
	{
		RotationFaker rotationFaker = EvlieyeClient.INSTANCE.getRotationFaker();
	...
	public static double getAngleToLastReportedLookVec(Vec3d vec)
	{
		...
		IClientPlayerEntity player = EvlieyeClient.IMC.getPlayer();
	...
	{
		Rotation needed = getNeededRotations(vec);
		return MathHelper.wrapDegrees(EvlieyeClient.MC.player.getYaw())
			- needed.yaw;
	}
	...
	{
		Entity player = EvlieyeClient.MC.player;
